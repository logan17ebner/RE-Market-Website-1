...
const MAJOR_CITIES = [
  ...
  { name: 'New Orleans', lat: 29.95, lon: -90.07, pop: 390000, class: 'large-city' as CityClass },
  { name: 'Tampa', lat: 27.95, lon: -82.46, pop: 400000, class: 'large-city' as CityClass },
  { name: 'Charlotte', lat: 35.23, lon: -80.84, pop: 920000, class: 'major-metro' as CityClass },
  { name: 'Indianapolis', lat: 39.77, lon: -86.16, pop: 890000, class: 'major-metro' as CityClass },
  { name: 'Columbus', lat: 39.96, lon: -82.99, pop: 910000, class: 'major-metro' as CityClass },
  { name: 'San Diego', lat: 32.72, lon: -117.15, pop: 1410000, class: 'major-metro' as CityClass },
  { name: 'Salt Lake City', lat: 40.76, lon: -111.89, pop: 210000, class: 'large-city' as CityClass },
  { name: 'Kansas City', lat: 39.10, lon: -94.58, pop: 510000, class: 'large-city' as CityClass },
  { name: 'Pittsburgh', lat: 40.44, lon: -79.99, pop: 300000, class: 'large-city' as CityClass },
  { name: 'Minneapolis', lat: 44.98, lon: -93.27, pop: 430000, class: 'major-metro' as CityClass },
  { name: 'St. Louis', lat: 38.63, lon: -90.20, pop: 300000, class: 'large-city' as CityClass },
  { name: 'Raleigh', lat: 35.78, lon: -78.64, pop: 470000, class: 'large-city' as CityClass },
  { name: 'Sacramento', lat: 38.58, lon: -121.49, pop: 530000, class: 'large-city' as CityClass },
  { name: 'Baltimore', lat: 39.29, lon: -76.61, pop: 590000, class: 'large-city' as CityClass },
