...
// Comparable US cities for residential market, tagged with which city classes they suit
const ALL_COMPARABLES: Record<MarketType, ComparableEntry[]> = {
  residential: [
    // Global gateways
    { city: 'Manhattan, NY',    country: 'USA', avgPricePerSqft: 1850, yoyChange: 2.1, healthScore: 62, cityClass: ['global-gateway'] },
    { city: 'San Francisco, CA',country: 'USA', avgPricePerSqft: 1100, yoyChange: 1.4, healthScore: 61, cityClass: ['global-gateway'] },
    { city: 'Brooklyn, NY',     country: 'USA', avgPricePerSqft: 900,  yoyChange: 3.2, healthScore: 66, cityClass: ['global-gateway'] },
    { city: 'Los Angeles, CA',  country: 'USA', avgPricePerSqft: 750,  yoyChange: 3.6, healthScore: 68, cityClass: ['global-gateway'] },
    // Major metros
    { city: 'Miami, FL',        country: 'USA', avgPricePerSqft: 620,  yoyChange: 5.8, healthScore: 76, cityClass: ['major-metro'] },
    { city: 'Boston, MA',       country: 'USA', avgPricePerSqft: 680,  yoyChange: 4.1, healthScore: 72, cityClass: ['major-metro'] },
    { city: 'Seattle, WA',      country: 'USA', avgPricePerSqft: 560,  yoyChange: 3.5, healthScore: 70, cityClass: ['major-metro'] },
    { city: 'Washington, DC',   country: 'USA', avgPricePerSqft: 520,  yoyChange: 2.9, healthScore: 68, cityClass: ['major-metro'] },
    { city: 'Chicago, IL',      country: 'USA', avgPricePerSqft: 310,  yoyChange: 3.1, healthScore: 64, cityClass: ['major-metro'] },
    { city: 'Phoenix, AZ',      country: 'USA', avgPricePerSqft: 250,  yoyChange: 4.2, healthScore: 67, cityClass: ['major-metro'] },
    { city: 'Dallas, TX',       country: 'USA', avgPricePerSqft: 220,  yoyChange: 3.8, healthScore: 66, cityClass: ['major-metro'] },
    { city: 'Houston, TX',      country: 'USA', avgPricePerSqft: 185,  yoyChange: 3.2, healthScore: 63, cityClass: ['major-metro'] },
    // Large cities
    { city: 'Austin, TX',       country: 'USA', avgPricePerSqft: 310,  yoyChange: 2.1, healthScore: 66, cityClass: ['large-city'] },
    { city: 'San Diego, CA',    country: 'USA', avgPricePerSqft: 620,  yoyChange: 4.8, healthScore: 72, cityClass: ['large-city'] },
    { city: 'Denver, CO',       country: 'USA', avgPricePerSqft: 280,  yoyChange: 3.8, healthScore: 68, cityClass: ['large-city'] },
    { city: 'Nashville, TN',    country: 'USA', avgPricePerSqft: 240,  yoyChange: 5.2, healthScore: 70, cityClass: ['large-city'] },
    { city: 'Atlanta, GA',      country: 'USA', avgPricePerSqft: 210,  yoyChange: 4.5, healthScore: 68, cityClass: ['large-city'] },
    { city: 'Portland, OR',     country: 'USA', avgPricePerSqft: 295,  yoyChange: 2.5, healthScore: 64, cityClass: ['large-city'] },
    { city: 'Tampa, FL',        country: 'USA', avgPricePerSqft: 280,  yoyChange: 5.5, healthScore: 71, cityClass: ['large-city'] },
    { city: 'Charlotte, NC',    country: 'USA', avgPricePerSqft: 215,  yoyChange: 5.0, healthScore: 69, cityClass: ['large-city'] },
    { city: 'Minneapolis, MN',  country: 'USA', avgPricePerSqft: 210,  yoyChange: 3.2, healthScore: 65, cityClass: ['large-city'] },
    { city: 'Salt Lake City, UT',country: 'USA',avgPricePerSqft: 290,  yoyChange: 3.5, healthScore: 67, cityClass: ['large-city'] },
    { city: 'Las Vegas, NV',    country: 'USA', avgPricePerSqft: 235,  yoyChange: 4.6, healthScore: 67, cityClass: ['large-city'] },
    { city: 'Sacramento, CA',   country: 'USA', avgPricePerSqft: 320,  yoyChange: 3.9, healthScore: 66, cityClass: ['large-city'] },
    // Mid cities
    { city: 'Raleigh, NC',      country: 'USA', avgPricePerSqft: 195,  yoyChange: 4.8, healthScore: 67, cityClass: ['mid-city'] },
    { city: 'Richmond, VA',     country: 'USA', avgPricePerSqft: 175,  yoyChange: 4.1, healthScore: 64, cityClass: ['mid-city'] },
    { city: 'Boise, ID',        country: 'USA', avgPricePerSqft: 210,  yoyChange: 4.2, healthScore: 66, cityClass: ['mid-city'] },
    { city: 'Columbus, OH',     country: 'USA', avgPricePerSqft: 175,  yoyChange: 4.5, healthScore: 65, cityClass: ['mid-city'] },
    { city: 'Indianapolis, IN', country: 'USA', avgPricePerSqft: 155,  yoyChange: 4.8, healthScore: 64, cityClass: ['mid-city'] },
    { city: 'Kansas City, MO',  country: 'USA', avgPricePerSqft: 160,  yoyChange: 4.2, healthScore: 63, cityClass: ['mid-city'] },
    { city: 'Louisville, KY',   country: 'USA', avgPricePerSqft: 145,  yoyChange: 3.8, healthScore: 61, cityClass: ['mid-city'] },
    { city: 'Spokane, WA',      country: 'USA', avgPricePerSqft: 145,  yoyChange: 3.2, healthScore: 60, cityClass: ['mid-city'] },
    { city: 'Tucson, AZ',       country: 'USA', avgPricePerSqft: 155,  yoyChange: 3.9, healthScore: 61, cityClass: ['mid-city'] },
    { city: 'Albuquerque, NM',  country: 'USA', avgPricePerSqft: 145,  yoyChange: 3.5, healthScore: 60, cityClass: ['mid-city'] },
    ...
    { city: 'Stamford, CT',     country: 'USA', avgPricePerSqft: 420,  yoyChange: 3.5, healthScore: 67, cityClass: ['suburb-primary'] },
    { city: 'Westchester, NY',  country: 'USA', avgPricePerSqft: 460,  yoyChange: 3.8, healthScore: 68, cityClass: ['suburb-primary'] },
    ...
    { city: 'Frisco, TX',       country: 'USA', avgPricePerSqft: 210,  yoyChange: 4.5, healthScore: 67, cityClass: ['suburb-secondary'] },
    ...
    { city: 'Henderson, NV',    country: 'USA', avgPricePerSqft: 220,  yoyChange: 4.2, healthScore: 64, cityClass: ['suburb-secondary'] },
    { city: 'Chandler, AZ',     country: 'USA', avgPricePerSqft: 230,  yoyChange: 4.0, healthScore: 64, cityClass: ['suburb-secondary'] },
    { city: 'Overland Park, KS',country: 'USA', avgPricePerSqft: 165,  yoyChange: 4.1, healthScore: 63, cityClass: ['suburb-secondary'] },
    // Small cities
    { city: 'Memphis, TN',      country: 'USA', avgPricePerSqft: 115,  yoyChange: 3.8, healthScore: 58, cityClass: ['small-city'] },
    { city: 'Birmingham, AL',   country: 'USA', avgPricePerSqft: 105,  yoyChange: 3.5, healthScore: 56, cityClass: ['small-city'] },
    { city: 'El Paso, TX',      country: 'USA', avgPricePerSqft: 130,  yoyChange: 4.2, healthScore: 59, cityClass: ['small-city'] },
    { city: 'Tulsa, OK',        country: 'USA', avgPricePerSqft: 120,  yoyChange: 3.8, healthScore: 57, cityClass: ['small-city'] },
    { city: 'Jackson, MS',      country: 'USA', avgPricePerSqft: 95,   yoyChange: 2.8, healthScore: 52, cityClass: ['small-city'] },
    { city: 'Shreveport, LA',   country: 'USA', avgPricePerSqft: 90,   yoyChange: 2.5, healthScore: 50, cityClass: ['small-city'] },
  ],
  office: [
